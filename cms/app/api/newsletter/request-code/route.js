...
export async function POST(req) {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: email,
      subject: 'Your Satguru DMC newsletter verification code',
      html: `
